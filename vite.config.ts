...
export default defineConfig({
  ...
  server: {
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://connect.facebook.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: http://i.pravatar.cc https://n8n.srv1218600.hstgr.cloud https://www.facebook.com; media-src 'self' data: blob: https:; connect-src 'self' https://n8n.srv1218600.hstgr.cloud https://connect.facebook.net; frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://www.facebook.com; object-src 'none'; base-uri 'self'; form-action 'self'; upgrade-insecure-requests;"
    }
  },
